...
export const PlatformGuideSection: React.FC<PlatformGuideSectionProps> = ({ onScanClick }) => {
  ...
  return (
    <section id="guide" className="py-20 px-5 max-w-6xl mx-auto scroll-mt-24">
            ...
            {[
              {
                step: "01",
                title: "CHECK",
                desc: "Submit a suspicious URL link, SMS message, or check password safety."
              },
              {
                step: "02",
                title: "ANALYZE",
      ...
      {/* Cyber Sense: Small Cybersecurity Awareness Interaction */}
      <div className="mb-16">
